...
<div class="container py-5">
    <ul class="nav justify-content-between nav-pills nav-prices" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link {{$loop->first ? 'active' : ''}}" id="pills-{{$brandKey}}-tab" data-bs-toggle="pill"
                data-bs-target="#pills-{{$brandKey}}" type="button" role="tab" aria-controls="pills-{{$brandKey}}"
                aria-selected="true">
            ...
            <div class="col-lg-8">
                ...
                <ul class="mb-4">
                    ...
                    <li> замена расходных материалов АКПП(фрикционные диски, стальные диски, прокладки, втулки,
                        сальники, фильтр);</li>
                    <li> дефектовка (оценка степени износа) и ремонт (если возможно)в случае необходимости - планетарных
                        передач, валов;</li>
                    <li> диагностика, промывка, текущий ремонт гидравлической плиты управления АКПП (включая расходные
                        материалы), без учета стоимости заменяемых соленоидов.</li>
                </ul>


                <p class="lead mb-2"> Стоимость ремонта АКПП, указанная на сайте, не включает в себя: </p>
                <ul class="mb-4">
                    <li>замену корпуса/части корпуса АКПП (Hard Parts), шлейфа плиты управления, электронные блоки АКПП
                    </li>
                    <li>замена механических элементов АКПП (валы, хабы, корпуса фрикционных пакетов, планетарные
                        редукторы в сборе и т.п.)</li>
                    <li>замену гидравлической плиты управления АКПП на новую. Необходимость подобной замены может быть
                        выявлена только после полного механического ремонта АКПП</li>
                </ul>
                ...
                <p>В стоимость ремонта АКПП не входит стоимость снятия/установки АКПП и замена трансмиссионной жидкости.
                </p>
